...
import { search, logChanges, getCollegeInfo} from './search'; // Assuming 'search.js' is in the same directory
            ...
            <div className="relative bg-black">
                <div className="image-container relative flex items-center justify-center">
                    ...
                    <div className="text-box-container absolute inset-x-0 bottom-0 mb-10 flex items-center justify-center">
                        ...
                        <button className="bg-green-500 rounded-r-lg px-4 py-2 cursor-pointer active:bg-green-600 border" id="gobutton" onClick={() => getCollegeInfo(search())}>Go</button>
                    </div>
                </div>
            </div>
